...
const MODEL_URLS = {
  base: {
    light: `${import.meta.env.BASE_URL}models/newmodels/Light_Base.glb`,
    dark: `${import.meta.env.BASE_URL}models/newmodels/Black_Base.glb`,
  },
  roof: {
    light: `${import.meta.env.BASE_URL}models/newmodels/Light_Roof.glb`,
  ...
  deck: `${import.meta.env.BASE_URL}models/newmodels/Deck.glb`,
};
